...
public class AdminPartnerCustomersController : ControllerBase
{
    private readonly IPartnerCustomerAdminService _service;

    public AdminPartnerCustomersController(IPartnerCustomerAdminService service)
    {
        _service = service;
    }

    [HttpGet]
    public async Task<IActionResult> SearchPagedAsync([FromQuery] PartnerCustomerAdminFilterDto filter, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("partner-filter-options")]
    public async Task<IActionResult> GetPartnerFilterOptionsAsync(CancellationToken cancellationToken)
    {
        var result = await _service.GetPartnerFilterOptionsAsync(cancellationToken);
        return Ok(result);
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateAsync([FromBody] CreatePartnerCustomerAdminRequest request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> UpdateAsync(Guid id, [FromBody] UpdatePartnerCustomerAdminRequest request, CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> UpdateStatusAsync(Guid id, [FromBody] UpdatePartnerCustomerStatusRequest request, CancellationToken cancellationToken)
    {
