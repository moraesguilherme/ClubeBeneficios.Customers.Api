...
public interface IPartnerCustomerAdminRepository
{
    ...
    Task<Guid> CreateAsync(CreatePartnerCustomerAdminRequest request, Guid? performedByUserId, CancellationToken cancellationToken = default);
    Task<bool> UpdateAsync(Guid id, UpdatePartnerCustomerAdminRequest request, Guid? performedByUserId, CancellationToken cancellationToken = default);
    ...
    Task<Guid> AddNoteAsync(Guid partnerCustomerId, AddNoteRequest request, Guid? createdByUserId, CancellationToken cancellationToken = default);
    ...
    Task<bool> UpdateStatusAsync(Guid partnerCustomerId, UpdatePartnerCustomerStatusRequest request, Guid? changedByUserId, CancellationToken cancellationToken = default);
}